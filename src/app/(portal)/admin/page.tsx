  ...
  return (
    <section className="space-y-6">
      <PageTitle
        ...
        subtitle="Gestion central de clientes, servicios y accesos."
      />

      <div className="grid gap-4 xl:grid-cols-2">
        <article className="rounded-xl border border-zinc-200 bg-white p-4">
          <h2 className="mb-3 font-title text-lg text-zinc-900">
            Crear cliente
          </h2>
        ...
        <article className="rounded-xl border border-zinc-200 bg-white p-4">
          ...
          <form action={createServiceCatalogAction} className="space-y-3">
            ...
            <button
              type="submit"
              className="rounded-lg border border-zinc-300 bg-black px-4 py-2 text-sm text-white"
            >
              Guardar catalogo
            </button>
          </form>
      ...
      <article className="rounded-xl border border-zinc-200 bg-white p-4">
        ...
        <form
          action={assignServiceToClientAction}
      ...
      <article className="rounded-xl border border-zinc-200 bg-white p-4">
        <h2 className="mb-3 font-title text-lg text-zinc-900">
          Credenciales y notas seguras
        </h2>
        <form
          action={createSecureNoteAction}
          ...
          {clients.map((client) => {
            const tokenNote = notes.find(
              (note) =>
                ...
                note.title === "Public ticket URL token",
            );
            let publicToken = "";
            if (tokenNote) {
              try {
