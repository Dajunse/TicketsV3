...
export default async function ActivitiesPage({
  ...
  searchParams: Promise<{ page?: string; showCompleted?: string }>;
}) {
  ...
  const buildPageHref = (page: number, includeCompleted = showCompleted) => {
      ...
      <article className="rounded-[20px] border border-transparent bg-gradient-to-b from-zinc-950 via-zinc-950 to-black p-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-2">
            <Link
              href={showCompleted ? "/activities" : "/activities?showCompleted=1"}
